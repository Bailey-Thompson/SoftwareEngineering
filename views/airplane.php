...
<form action="/viewAirplane" method="POST">
<input type="int" id="NUMSER" name="NUMSER" placeholder="Serial Number">
<button type="submit">View</button>
<button type="submit" formaction="/deleteAirplane">Delete</button>
</form>
